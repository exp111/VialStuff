// HIDAPITest.cpp : Diese Datei enthält die Funktion "main". Hier beginnt und endet die Ausführung des Programms.
//
...
#include <chrono>
#include <thread>
#pragma comment(lib, "include/hidapi.lib") 
